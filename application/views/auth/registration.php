                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="<?=base_url().'main_controller/user_registration_page'?>">
                                <?=$this->session->flashdata('message')?>
                                    ...
                                    <div class="form-group">
                                        <input type="date" class="form-control form-control-user"
                                            id="ttl"  name="ttl" aria-describedby="emailHelp"
                                            placeholder="Tanggal Lahir"><?=form_error('ttl',"<span class='text-danger'>","</span>")?>
                                    </div>
                                    <div class="form-group">
