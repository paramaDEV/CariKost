...
-- Dumping database structure for carikost
CREATE DATABASE IF NOT EXISTS `carikost` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `carikost`;

-- Dumping structure for table carikost.admin
...
-- Dumping data for table carikost.admin: ~3 rows (approximately)
/*!40000 ALTER TABLE `admin` DISABLE KEYS */;
REPLACE INTO `admin` (`id`, `nama`, `ttl`, `jenis_kelamin`, `email`, `password`, `foto`) VALUES
	(4, 'Fany Parama Admaja', '2000-07-06', 'Laki-laki', 'admin1@gmail.com', '$2y$10$/jgC0Qpf2X.0bJX.kd60LuScbUkm.RhVOkLVY.6F55pjt86oetwoa', '080b39de63e74a07ee8fe4e29e3b30b6.jpg'),
...
-- Dumping structure for table carikost.data_kost
...
-- Dumping data for table carikost.data_kost: ~99 rows (approximately)
...
REPLACE INTO `data_kost` (`id`, `nmkost`, `pemilik`, `id_kota_kab`, `alamat`, `telepon`, `harga`, `jenis`, `pembayaran`, `longitude`, `latitude`, `foto`) VALUES
	...
	(23, 'D\'Fortune Boarding House', 'Ibu Cindy', 1, 'Jl. Simpang S. Kalijaga V No.8, Dinoyo, Kec. Lowokwaru, Kota Malang, Jawa Timur 65149', '628118282190', 475000, 'Putri', 'Bulanan', 112.6023178, -7.9517288, '4c9d74d342ac6f4e65a3baad39aaae08.jpg'),
	...
	(101, 'Kost Bu Lucy', 'Ibu Lucy', 1, 'Jl. Simpang Setaman, Lowokwaru, Kec. Lowokwaru, Kota Malang, Jawa Timur 65141', '081222556898', 11000000, 'Putri', 'Tahunan', 112.6317062, -7.9534335, '');
/*!40000 ALTER TABLE `data_kost` ENABLE KEYS */;

-- Dumping structure for table carikost.favorit
...
-- Dumping data for table carikost.favorit: ~1 rows (approximately)
...
-- Dumping structure for table carikost.kota_kab
...
-- Dumping data for table carikost.user: ~0 rows (approximately)
